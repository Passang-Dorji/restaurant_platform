defmodule RestaurantPlatform.Repo.Migrations.CreateOrderLists do
  use Ecto.Migration
  ...
  def change do
    create table(:order_lists, primary_key: false) do
      ...
      add :total_prices, :decimal
      add :order_id, references(:orders, on_delete: :nothing, type: :binary_id)
      add :menu_item_id, references(:menu_items, on_delete: :nothing, type: :binary_id)
