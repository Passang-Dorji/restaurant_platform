defmodule RestaurantPlatformWeb.Order_listControllerTest do
  ...
  describe "update order_list" do
    ...
    test "renders order_list when data is valid", %{conn: conn, order_list: %Order_list{id: id} = order_list} do
