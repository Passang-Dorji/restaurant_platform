defmodule RestaurantPlatformWeb.OrderControllerTest do
  ...
  @update_attrs %{
    ordered_at: ~U[2024-08-28 07:29:00Z],
    payed_at: ~U[2024-08-28 07:29:00Z],
    total_amount: "456.7"
  }
  ...
  describe "create order" do
    test "renders order when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "ordered_at" => "2024-08-27T07:29:00Z",
               "payed_at" => "2024-08-27T07:29:00Z",
               "total_amount" => "120.5"
  ...
  describe "update order" do
    ...
    test "renders order when data is valid", %{conn: conn, order: %Order{id: id} = order} do
      ...
      assert %{
               "id" => ^id,
               "ordered_at" => "2024-08-28T07:29:00Z",
               "payed_at" => "2024-08-28T07:29:00Z",
               "total_amount" => "456.7"
             } = json_response(conn, 200)["data"]
    end
