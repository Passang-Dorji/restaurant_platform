defmodule RestaurantPlatform.SessionsTest do
  ...
  describe "sessions" do
    ...
    import RestaurantPlatform.SessionsFixtures
    ...
    test "create_session/1 with valid data creates a session" do
      valid_attrs = %{session_token: "some session_token", start_time: ~U[2024-08-26 10:17:00Z], end_time: ~U[2024-08-26 10:17:00Z]}

      assert {:ok, %Session{} = session} = Sessions.create_session(valid_attrs)
      assert session.session_token == "some session_token"
      assert session.start_time == ~U[2024-08-26 10:17:00Z]
      assert session.end_time == ~U[2024-08-26 10:17:00Z]
    end
    ...
    test "update_session/2 with valid data updates the session" do
      session = session_fixture()
      update_attrs = %{session_token: "some updated session_token", start_time: ~U[2024-08-27 10:17:00Z], end_time: ~U[2024-08-27 10:17:00Z]}
      ...
      assert session.start_time == ~U[2024-08-27 10:17:00Z]
      assert session.end_time == ~U[2024-08-27 10:17:00Z]
    end
